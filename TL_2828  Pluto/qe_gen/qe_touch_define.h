...
/* begin: Workaround for FSP V0.12.0 */
#if !defined (TOUCH_UART_MONITOR_NONE)
#include <stdio.h>
#include "rm_touch_cfg.h"

#if (!defined(TOUCH_CFG_UART_MONITOR_SUPPORT) || (TOUCH_CFG_UART_MONITOR_SUPPORT == 0))
#define TOUCH_UART_MONITOR_NONE (0)
//uint8_t g_touch_uart_monitor_num;
#endif
#endif
/* end: Workaround for FSP V0.12.0 */
...
***********************************************************************************************************************/
#define CONFIG01_INDEX_K1     (0)
#define CONFIG01_MASK_K1      (1ULL << CONFIG01_INDEX_K1)
