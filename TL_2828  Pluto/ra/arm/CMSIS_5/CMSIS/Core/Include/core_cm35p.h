...
extern volatile int32_t ITM_tRxBuffer;                              /*!< External variable to receive characters. */
#define                 ITM_tRxBuffer_EMPTY  ((int32_t)0x5AA55AA5U) /*!< Value identifying \ref ITM_tRxBuffer is ready for next character. */
...
/**
  ...
  \details Inputs a character via the external variable \ref ITM_tRxBuffer.
...
__STATIC_INLINE int32_t ITM_ReceiveChar (void)
{
  ...
  if (ITM_tRxBuffer != ITM_tRxBuffer_EMPTY)
  {
    ch = ITM_tRxBuffer;
    ITM_tRxBuffer = ITM_tRxBuffer_EMPTY;       /* ready for next character */
  }
...
/**
  ...
  \details Checks whether a character is pending for reading in the variable \ref ITM_tRxBuffer.
