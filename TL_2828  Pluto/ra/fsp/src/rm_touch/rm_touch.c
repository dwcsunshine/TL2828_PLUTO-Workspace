...
//uint16_t       g_touch_button_countvalue[3];
//uint16_t		g_touch_button_reference[3];
uint16_t       g_touch_button_countvalue[CTSU_CFG_NUM_SELF_ELEMENTS + (CTSU_CFG_NUM_MUTUAL_ELEMENTS * 2)];
                            ...
                            uint16_t           * p_wheel_position)
{
	...
	memcpy(&g_touch_button_countvalue[0],&data[0],sizeof(g_touch_button_countvalue));
    FSP_ERROR_RETURN(FSP_ERR_CTSU_SCANNING != err, FSP_ERR_CTSU_SCANNING);
