...
extern uint16_t       g_touch_button_countvalue[CTSU_CFG_NUM_SELF_ELEMENTS + (CTSU_CFG_NUM_MUTUAL_ELEMENTS * 2)];
//extern uint16_t g_touch_button_reference[3];
//extern uint16_t       g_touch_button_countvalue[3];
